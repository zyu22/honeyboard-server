...
CREATE TABLE algorithm_guide ( -- 0
	id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE algorithm_problem ( -- 0
	id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE programming_language ( -- 0
    id INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) UNIQUE NOT NULL
);

--  Algorithm_Problem_Solution 테이블 생성 (알고리즘 해결)
CREATE TABLE algorithm_problem_solution ( -- 0
	id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE algorithm_problem_tag ( -- 0
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE track_project_board ( -- 0
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE track_team_member ( -- 0
		id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE track_excluded_member ( -- 0
	id INT PRIMARY KEY AUTO_INCREMENT,
...
/* Finale Team Member */
CREATE TABLE finale_team_member ( -- 0
    id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE finale_excluded_member ( -- 0
	id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE finale_project_board( -- 0
    id INT PRIMARY KEY AUTO_INCREMENT,
