...
//        given(finaleProjectService.getFinaleProjectBoardDetail(projectId, boardId)).willReturn(response);
//
//        // when & then
...
//        User user = new User();
//        given(finaleProjectService.createFinaleProjectBoard(eq(projectId), any(), any())).willReturn(1);
//
//        // when & then
