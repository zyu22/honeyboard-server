...
public interface AlgorithmSolutionService {
	...
	PageResponse<AlgorithmSolutionResponse> getAllAlgorithmSolution(int problemId, int generationId, List<String> languages, String sortType, int currentPage, int userId);
